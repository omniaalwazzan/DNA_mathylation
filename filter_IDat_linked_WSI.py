...
root_directory  = r"D:\Methylation_data_all_tumours_May23\Part_3_101_150"

def step_1(root_directory):
    ...
    filtered_data = pd.read_csv(r"D:/2ndYear/Slivia's project/mythalExp/filterd_data.csv")  
    ...
    merged_data.to_csv(r"D:\2ndYear\Slivia's project\mythalExp\preprocessing\cases_Part_3_101_150.csv")
    return merged_data

csv_from_step1 =step_1(root_directory)
